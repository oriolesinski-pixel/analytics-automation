    ...
    constructor() {
      ...
      this.componentDetectors = [
...

        {
            ...
            contextCollection: {"search_parents":["form.login-form"],"extract_fields":["email","password"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'RegisterForm',
            type: 'form',
            selectors: ["form.register-form"],
            purpose: 'User registration',
            contextNeeded: ["name","email","password","confirmPassword"],
            contextCollection: {"search_parents":["form.register-form"],"extract_fields":["name","email","password","confirmPassword"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'ShippingInfoForm',
            type: 'form',
            selectors: ["form.shipping-info-form"],
            purpose: 'Collect shipping information',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":["form.shipping-info-form"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'PaymentForm',
            type: 'form',
            selectors: ["form.payment-form"],
            purpose: 'Process payment',
            contextNeeded: ["cardNumber","cardName","expiryDate","cvv","saveCard"],
            contextCollection: {"search_parents":["form.payment-form"],"extract_fields":["cardNumber","cardName","expiryDate","cvv","saveCard"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            type: 'custom',
            selectors: [".carousel"],
            purpose: 'Navigate carousel slides',
