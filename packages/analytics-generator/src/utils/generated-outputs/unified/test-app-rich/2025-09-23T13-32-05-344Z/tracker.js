(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-1758634296281',
      ...
      this.componentDetectors = [
...

        {
            ...
            type: 'button',
            selectors: ["button[onClick='prevSlide']","[aria-label='Previous slide']"],
            purpose: 'Navigate to previous carousel slide',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[onClick='prevSlide']","[aria-label='Previous slide']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'NextSlideButton',
            type: 'button',
            selectors: ["button[onClick='nextSlide']","[aria-label='Next slide']"],
            purpose: 'Navigate to next carousel slide',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[onClick='nextSlide']","[aria-label='Next slide']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'RemoveFromCartButton',
            type: 'button',
            selectors: ["button[onClick='removeFromCart']","[data-action='remove-from-cart']"],
            purpose: 'Remove product from cart',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":["button[onClick='removeFromCart']","[data-action='remove-from-cart']"],"extract_fields":["product-id"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },

        {
            name: 'ClearCartButton',
            type: 'button',
            selectors: ["button[onClick='clearCart']","[data-action='clear-cart']"],
            purpose: 'Clear all items from cart',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[onClick='clearCart']","[data-action='clear-cart']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'ContinueShoppingLink',
            type: 'link',
            selectors: ["a[href='/products']","[data-action='continue-shopping']"],
            purpose: 'Navigate to product listing page',
            contextNeeded: [],
            contextCollection: {"search_parents":["a[href='/products']","[data-action='continue-shopping']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'RegisterLink',
            type: 'link',
            selectors: ["a[href='/auth/register']","[data-action='register']"],
            purpose: 'Navigate to registration page',
            contextNeeded: [],
            contextCollection: {"search_parents":["a[href='/auth/register']","[data-action='register']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'LoginLink',
            type: 'link',
            selectors: ["a[href='/auth/login']","[data-action='login']"],
            purpose: 'Navigate to login page',
            contextNeeded: [],
            contextCollection: {"search_parents":["a[href='/auth/login']","[data-action='login']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-1758634296281');
