# AI-Enhanced Analytics Integration Guide for test-app-rich-1758634296281
...
- **PrevSlideButton** (button): Navigate to previous carousel slide
...
- **ContinueShoppingLink** (link): Navigate to product listing page
- **RegisterLink** (link): Navigate to registration page
- **LoginLink** (link): Navigate to login page
...
**Generated:** 2025-09-23T13:32:05.340Z
