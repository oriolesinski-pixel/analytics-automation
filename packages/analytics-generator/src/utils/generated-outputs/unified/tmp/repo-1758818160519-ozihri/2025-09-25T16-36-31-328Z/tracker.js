(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-ihf0tedge1',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Navigational or action button',
            contextNeeded: [],
...

        {
            name: 'Input',
            type: 'form_input',
            selectors: [".appearance-none",".relative",".block",".w-full",".px-3",".py-2",".border",".border-gray-300",".placeholder-gray-500",".text-gray-900",".rounded-md",".focus:outline-none",".focus:ring-blue-500",".focus:border-blue-500",".focus:z-10",".sm:text-sm"],
...

        {
            ...
            purpose: 'Quantity control buttons',
            contextNeeded: ["productId","quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]",".cart-item"],"extract_fields":["productId","quantity"]}
        },
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".bg-red-500",".hover:bg-red-700",".text-white"],
            purpose: 'Clear cart',
            contextNeeded: [],
            contextCollection: {"search_parents":[".product-card","[data-product]","form"],"extract_fields":["product-id","price","selected-color"],"sibling_context":["input[name='size']",".color-selector.active"],"data_attributes":["data-product-id","data-sku"]}
        },

        {
            ...
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["currentSlide"]}
        },

        {
            ...
            purpose: 'Carousel navigation buttons',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["currentSlide"]}
        },

        {
            name: 'CarouselDots',
            type: 'custom',
            selectors: [".absolute",".bottom-4",".left-1/2",".-translate-x-1/2",".flex",".gap-2"],
            purpose: 'Carousel dot indicators',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["currentSlide"]}
        },

        {
            name: 'CarouselDotButton',
            type: 'button',
            selectors: [".w-2",".h-2",".rounded-full",".transition-all",".bg-white",".bg-white/50",".hover:bg-white/75",".w-8"],
            purpose: 'Carousel dot navigation',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":["[data-carousel]"],"extract_fields":["currentSlide"]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-ihf0tedge1');
