(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-a9xqu8ppp3',
      ...
      this.componentDetectors = [
        {
            name: 'Button',
            type: 'button',
            selectors: [".bg-blue-600",".hover:bg-blue-700",".inline-block"],
...

        {
            name: 'IconButton',
            type: 'icon',
            selectors: [".p-1",".hover:bg-gray-100",".rounded"],
            purpose: 'Quantity control, remove from cart',
            contextNeeded: ["product_id","selected_state"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id","selected-state"]}
        },

        {
            name: 'Link',
            type: 'link',
            selectors: [".text-blue-600",".hover:text-blue-500",".font-medium"],
            purpose: 'Navigation, authentication',
            contextNeeded: [],
...

        {
            name: 'Form',
            type: 'form',
            selectors: ["form.mt-8","form.space-y-6","form.onSubmit"],
            purpose: 'Authentication, checkout',
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form"],"extract_fields":["form_data"]}
        },

        {
            name: 'Input',
            type: 'form_input',
            selectors: ["input.appearance-none","input.rounded-none","input.relative","input.block","input.w-full","input.px-3","input.py-2","input.border","input.border-gray-300","input.placeholder-gray-500","input.text-gray-900","input.rounded-t-md","input.focus:outline-none","input.focus:ring-blue-500","input.focus:border-blue-500","input.focus:z-10","input.sm:text-sm"],
            purpose: 'Form field input',
            contextNeeded: ["form_data"],
            contextCollection: {"search_parents":["form"],"extract_fields":["form_data"]}
        },
...

        {
            name: 'Modal',
            type: 'custom',
            selectors: ["[role=\"dialog\"]",".fixed",".inset-0",".z-50",".overflow-y-auto"],
            purpose: 'Display additional information or options',
            contextNeeded: [],
            contextCollection: {"search_parents":[]}
        },

        {
            name: 'Accordion',
            type: 'custom',
            selectors: [".accordion",".accordion-item",".accordion-header",".accordion-body"],
            purpose: 'Expand/collapse content sections',
            contextNeeded: [],
            contextCollection: {"search_parents":[]}
        },

        {
            name: 'Tabs',
            type: 'custom',
            selectors: [".tabs",".tab-list",".tab-item",".tab-panel"],
...

        {
            name: 'Dropdown',
            type: 'custom',
            selectors: [".dropdown",".dropdown-toggle",".dropdown-menu"],
...

        {
            name: 'SearchInput',
            type: 'custom',
            selectors: [".search-input",".search-button"],
            purpose: 'Search for products or content',
            contextNeeded: ["search_query"],
            contextCollection: {"search_parents":["form"],"extract_fields":["search_query"]}
        },

        {
            name: 'FilterPanel',
            type: 'custom',
            selectors: [".filter-panel",".filter-button",".filter-options"],
            purpose: 'Filter products by various criteria',
            contextNeeded: ["filter_state"],
            contextCollection: {"search_parents":["form"],"extract_fields":["filter_state"]}
        },

        {
            ...
            contextNeeded: ["page_number"],
            contextCollection: {"search_parents":["form"],"extract_fields":["page_number"]}
        },

        {
            name: 'RouterLink',
            type: 'link',
            selectors: ["[href^=\"/\"]",".text-gray-700",".hover:text-blue-600",".transition-colors"],
            purpose: 'Navigation within the application',
            contextNeeded: [],
            contextCollection: {"search_parents":[]}
        },

        {
            ...
            purpose: 'Access the shopping cart',
            contextNeeded: ["cart_state"],
            contextCollection: {"search_parents":["[data-product]"],"extract_fields":["cart_state"]}
        },

        {
            ...
            type: 'icon',
            selectors: [".relative",".text-gray-700",".hover:text-blue-600",".transition-colors"],
            purpose: 'Access the wishlist',
            contextNeeded: ["wishlist_state"],
            contextCollection: {"search_parents":["[data-product]"],"extract_fields":["wishlist_state"]}
        },

        {
            ...
            purpose: 'Access user-related functionality (login, profile, etc.)',
            contextNeeded: ["auth_state"],
            contextCollection: {"search_parents":[],"extract_fields":["auth_state"]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-a9xqu8ppp3');
