(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-semc0o18os',
      ...
      this.componentDetectors = [
        {
            name: 'Button',
            type: 'button',
            selectors: [".appearance-none.rounded-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-t-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm","#email","#password"],
            purpose: 'Login form submission',
            contextNeeded: ["email","password"],
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword","product_id","quantity"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".appearance-none.relative.block.w-full.px-3.py-2.border.border-gray-300.placeholder-gray-500.text-gray-900.rounded-md.focus:outline-none.focus:ring-blue-500.focus:border-blue-500.focus:z-10.sm:text-sm","#name","#email","#password","#confirmPassword"],
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".bg-blue-600.text-white.px-6.py-3.rounded-lg.hover:bg-blue-700.transition-colors"],
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".p-1.hover:bg-gray-100.rounded",".w-4.h-4"],
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".text-red-500.hover:text-red-700",".w-5.h-5"],
...

        {
            name: 'Button',
            type: 'button',
            selectors: [".text-red-600.hover:text-red-700"],
            purpose: 'Clear cart',
            contextNeeded: [],
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword","product_id","quantity"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Input',
            type: 'form_input',
            selectors: [".px-4.py-2.border.rounded-lg","#firstName","#lastName","#email","#phone","#address","#city","#state","#zipCode","#country"],
            purpose: 'Capture shipping information',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":["form"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country","cardNumber","cardName","expiryDate","cvv"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Form',
            type: 'form',
            selectors: [".mt-8.space-y-6"],
            purpose: 'Submit shipping information',
            contextNeeded: ["shippingInfo"],
            contextCollection: {"search_parents":[],"extract_fields":["shippingInfo","paymentInfo","items","total"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Input',
            type: 'form_input',
            selectors: [".px-4.py-2.border.rounded-lg","#cardNumber","#cardName","#expiryDate","#cvv"],
            purpose: 'Capture payment information',
...

        {
            ...
            type: 'form',
            selectors: [".mt-8.space-y-6"],
            purpose: 'Submit payment information and complete order',
            contextNeeded: ["paymentInfo","items","shippingInfo","total"],
            contextCollection: {"search_parents":[],"extract_fields":["shippingInfo","paymentInfo","items","total"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Navigate to different pages after successful order',
            contextNeeded: ["orderId"],
            contextCollection: {"search_parents":["form"],"extract_fields":["email","password","name","confirmPassword","product_id","quantity"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Carousel',
            type: 'custom',
            selectors: [".relative.w-full.h-\\[400px\\].md:h-\\[500px\\].overflow-hidden.rounded-lg",".absolute.inset-0.transition-transform.duration-500.ease-in-out",".w-2.h-2.rounded-full.transition-all"],
            purpose: 'Navigate to product details page',
            contextNeeded: ["product_id","product_image","product_title","product_subtitle"],
            contextCollection: {"search_parents":[],"extract_fields":["product_id","product_image","product_title","product_subtitle"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            name: 'Link',
            type: 'link',
            selectors: [".relative.text-gray-700.hover:text-blue-600.transition-colors",".w-6.h-6"],
            purpose: 'Navigate to login page',
            contextNeeded: [],
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Button',
            type: 'button',
            selectors: [".md:hidden.text-gray-700",".w-6.h-6"],
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-semc0o18os');
      console.log('📊 Tracking 20 discovered components');
