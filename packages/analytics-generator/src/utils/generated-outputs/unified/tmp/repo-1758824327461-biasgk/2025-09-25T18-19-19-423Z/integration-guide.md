# AI-Enhanced Analytics Integration Guide for test-app-rich-demo-2025-09-25-semc0o18os
...
- **Button** (button): Login form submission
- **Link** (link): Navigate to registration page
- **Button** (button): Registration form submission
- **Link** (link): Navigate to login page
- **Button** (button): Continue shopping
- **Button** (button): Update product quantity in cart
- **Button** (button): Remove product from cart
- **Button** (button): Clear cart
- **Input** (form_input): Capture shipping information
- **Form** (form): Submit shipping information
- **Input** (form_input): Capture payment information
- **Form** (form): Submit payment information and complete order
- **Button** (button): Navigate to different pages after successful order
- **Carousel** (custom): Navigate to product details page
- **Link** (link): Navigate to different pages
- **Link** (link): Navigate to cart page
- **Link** (link): Navigate to wishlist page
- **Button** (button): Logout user
- **Link** (link): Navigate to login page
- **Button** (button): Toggle mobile menu
...
**Generated:** 2025-09-25T18:19:19.423Z
