(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-clrw8f1z2z',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Primary action buttons (e.g., continue shopping, login, register)',
            contextNeeded: [],
...

        {
            ...
            purpose: 'Secondary links (e.g., sign in, create account)',
            contextNeeded: [],
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            name: 'LoginForm',
            type: 'form',
            selectors: [".mt-8",".space-y-6",".rounded-md",".shadow-sm",".relative",".block",".w-full",".px-3",".py-2",".border",".border-gray-300",".placeholder-gray-500",".text-gray-900",".rounded-t-md",".focus:outline-none",".focus:ring-blue-500",".focus:border-blue-500",".focus:z-10",".sm:text-sm"],
            purpose: 'User login',
            contextNeeded: ["email","password"],
            contextCollection: {"search_parents":[".login-container"],"extract_fields":["email","password"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextCollection: {"search_parents":[".register-container"],"extract_fields":["name","email","password","confirmPassword"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            purpose: 'Shipping information for checkout',
            contextNeeded: ["firstName","lastName","email","phone","address","city","state","zipCode","country"],
            contextCollection: {"search_parents":[".checkout-container"],"extract_fields":["firstName","lastName","email","phone","address","city","state","zipCode","country"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            type: 'form',
            selectors: [".mt-1",".appearance-none",".relative",".block",".w-full",".px-3",".py-2",".border",".border-gray-300",".placeholder-gray-500",".text-gray-900",".rounded-md",".focus:outline-none",".focus:ring-blue-500",".focus:border-blue-500",".focus:z-10",".sm:text-sm"],
            purpose: 'Payment information for checkout',
            contextNeeded: ["cardNumber","cardName","expiryDate","cvv","saveCard"],
            contextCollection: {"search_parents":[".checkout-container"],"extract_fields":["cardNumber","cardName","expiryDate","cvv","saveCard"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            ...
            contextCollection: {"search_parents":[".carousel"],"extract_fields":["slide_index"],"sibling_context":[],"data_attributes":["data-slide-index"]}
        },
...

        {
            ...
            purpose: 'Add a product to the wishlist',
            contextNeeded: ["product_id"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id"],"sibling_context":[],"data_attributes":["data-product-id"]}
        },
        ...
        {
            name: 'FillTestCredentials',
            type: 'button',
            selectors: [],
            purpose: 'Fill in test login credentials',
            contextNeeded: [],
            contextCollection: {"search_parents":[".login-container"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-clrw8f1z2z');
