(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-7gv7q63ju2x',
      ...
      this.componentDetectors = [
...

        {
            ...
            contextNeeded: [],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id","product-link"],"data_attributes":["data-product-id"]}
        },
...

        {
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["form-data"]}
        },

        {
            ...
            contextCollection: {"search_parents":[""],"extract_fields":["form-data"]}
        },
...

        {
            ...
            contextNeeded: ["paymentInfo","shippingInfo","items","total"],
            contextCollection: {"search_parents":[""],"extract_fields":["form-data"]}
        },
...

        {
            ...
            purpose: 'Navigate to product pages from carousel',
            contextNeeded: ["product_id","product_link"],
            contextCollection: {"search_parents":[""],"extract_fields":["product-id","product-link"]}
        },

        {
            ...
            purpose: 'Navigate to different pages from header',
            contextNeeded: [],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id","product-link"],"data_attributes":["data-product-id"]}
        },

        {
            ...
            purpose: 'Navigate to wishlist and cart pages',
            contextNeeded: [],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["product-id","product-link"],"data_attributes":["data-product-id"]}
        },
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-7gv7q63ju2x');
      console.log('📊 Tracking 19 discovered components');
