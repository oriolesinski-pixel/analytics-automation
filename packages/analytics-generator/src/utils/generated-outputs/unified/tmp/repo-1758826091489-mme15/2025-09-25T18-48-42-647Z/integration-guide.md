# AI-Enhanced Analytics Integration Guide for test-app-rich-demo-2025-09-25-7gv7q63ju2x
...
- **Button** (button): Adjust product quantity in cart
...
- **Carousel** (custom): Navigate to product pages from carousel
- **Link** (link): Navigate to different pages from header
- **Link** (link): Navigate to wishlist and cart pages
...
**Generated:** 2025-09-25T18:48:42.646Z
