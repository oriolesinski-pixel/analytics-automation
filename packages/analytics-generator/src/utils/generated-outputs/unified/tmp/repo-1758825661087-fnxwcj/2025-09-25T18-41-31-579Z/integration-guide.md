# AI-Enhanced Analytics Integration Guide for test-app-rich-demo-2025-09-25-lv07xwm1zw
...
- **Button** (button): Navigational or action buttons (e.g. Continue Shopping, Create Account)
- **Link** (link): Navigation links (e.g. sign in, create account, back to home)
- **InputField** (form_input): User input fields (e.g. email, password, name)
- **QuantitySelector** (selector): Quantity selection for cart items
- **RemoveFromCartButton** (button): Remove item from cart
- **PaymentForm** (form): Payment processing form
- **ShippingForm** (form): Shipping information form
- **WishlistToggle** (icon): Add/remove item from wishlist
- **CartIcon** (icon): Navigate to cart page
- **WishlistIcon** (icon): Navigate to wishlist page
- **UserIcon** (icon): Navigate to login page
- **LogoutButton** (button): Log out the user
- **Carousel** (custom): Image carousel for featured products
...
**Generated:** 2025-09-25T18:41:31.579Z
