(function(root, factory) {
  ...
  class AnalyticsTracker {
    constructor() {
      this.config = {
        appKey: 'test-app-rich-demo-2025-09-25-lv07xwm1zw',
      ...
      this.componentDetectors = [
        {
            ...
            purpose: 'Navigational or action buttons (e.g. Continue Shopping, Create Account)',
            contextNeeded: [],
...

        {
            name: 'Link',
            type: 'link',
            selectors: [".font-medium",".text-blue-600",".hover:text-blue-500","a[href]"],
            purpose: 'Navigation links (e.g. sign in, create account, back to home)',
            contextNeeded: [],
            contextCollection: {"search_parents":[],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'InputField',
            type: 'form_input',
            selectors: ["input[type=\"email\"]","input[type=\"password\"]","input[type=\"text\"]"],
            purpose: 'User input fields (e.g. email, password, name)',
            contextNeeded: ["formData"],
            contextCollection: {"search_parents":["form"],"extract_fields":["formData"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'QuantitySelector',
            type: 'selector',
            selectors: ["button[onClick*=\"updateQuantity\"]","span[className*=\"quantity\"]"],
            purpose: 'Quantity selection for cart items',
            contextNeeded: ["item.id","item.quantity"],
            contextCollection: {"search_parents":[".product-card","[data-product]"],"extract_fields":["item.id","item.quantity"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'RemoveFromCartButton',
            type: 'button',
            selectors: ["button[onClick*=\"removeFromCart\"]",".text-red-500"],
            purpose: 'Remove item from cart',
            contextNeeded: ["item.id"],
            contextCollection: {"search_parents":[".cart-item"],"extract_fields":["item.id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            ...
            contextCollection: {"search_parents":["form"],"extract_fields":["paymentData"],"sibling_context":[],"data_attributes":[]}
        },
...

        {
            name: 'WishlistToggle',
            type: 'icon',
            selectors: ["[onClick*=\"toggleWishlist\"]",".product-card__wishlist-btn"],
            purpose: 'Add/remove item from wishlist',
            contextNeeded: ["product.id"],
            contextCollection: {"search_parents":[".product-card"],"extract_fields":["product.id"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'CartIcon',
            type: 'icon',
            selectors: ["a[href=\"/cart\"]",".relative"],
            purpose: 'Navigate to cart page',
            contextNeeded: ["itemCount"],
            contextCollection: {"search_parents":["a[href='/cart']"],"extract_fields":["itemCount"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'WishlistIcon',
            type: 'icon',
            selectors: ["a[href=\"/wishlist\"]"],
            purpose: 'Navigate to wishlist page',
            contextNeeded: [],
            contextCollection: {"search_parents":["a[href='/wishlist']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'UserIcon',
            type: 'icon',
            selectors: ["a[href=\"/auth/login\"]"],
            purpose: 'Navigate to login page',
            contextNeeded: ["isAuthenticated"],
            contextCollection: {"search_parents":["a[href='/auth/login']"],"extract_fields":["isAuthenticated"],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'LogoutButton',
            type: 'button',
            selectors: ["button[onClick=\"logout\"]"],
            purpose: 'Log out the user',
            contextNeeded: [],
            contextCollection: {"search_parents":["button[onClick='logout']"],"extract_fields":[],"sibling_context":[],"data_attributes":[]}
        },

        {
            name: 'Carousel',
            type: 'custom',
            selectors: [".relative",".w-full",".h-[400px]",".md:h-[500px]"],
            purpose: 'Image carousel for featured products',
            contextNeeded: ["currentSlide"],
            contextCollection: {"search_parents":[".relative",".w-full",".h-[400px]",".md:h-[500px]"],"extract_fields":["currentSlide"],"sibling_context":[],"data_attributes":[]}
        }
      ];
    ...
    initAutoTracking() {
      console.log('🤖 AI-Enhanced Analytics initialized for test-app-rich-demo-2025-09-25-lv07xwm1zw');
