# AI-Enhanced Analytics Integration Guide for test-app-rich-demo-2025-09-25-5tqqpvt9fxo
...
- **Carousel** (custom): Carousel of featured products or promotions
- **CarouselNavigation** (button): Navigate to previous/next slide in carousel
- **CarouselIndicator** (button): Navigate to a specific slide in carousel
...
- **UserMenu** (custom): User menu with login/logout options
- **MobileMenuButton** (button): Toggle mobile menu
...
**Generated:** 2025-09-25T19:25:03.853Z
