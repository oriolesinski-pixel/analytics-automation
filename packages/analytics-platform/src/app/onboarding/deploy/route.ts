///Users/oriolesinski/main-project-repo/analytics-automation/packages/analytics-platform/src/app/onboarding/deploy/route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Helper function to construct file paths with subdirectory
    ...
    console.log('Deploy configuration:', {
      ...
      repoName,
      subdir: subdir || 'root',
      trackerPath: getFilePath('public/tracker.js'),
      providerPath: getFilePath('app/components/AnalyticsProvider.tsx')
    });
...
### Installation:
1. Add \`<script src="/tracker.js"></script>\` to your HTML${subdir ? ` (relative to ${subdir})` : ''}
2. Import and wrap your app with \`<AnalyticsProvider>\`
